...
class StatisticsUtilsTest2 {
    ...
    private fun compareResultWith(expectedResult: StatsResult) {
        Assert.assertThat(result.completedTasksPercent, `is`(expectedResult.completedTasksPercent))
        Assert.assertThat(result.activeTasksPercent, `is`(expectedResult.activeTasksPercent))
    }
